...
class Chat extends Component {
  // The state is initialized in the constructor and the functions below are
  // bound with 'this'.
    constructor() {
        super();
        this.state = {
    ...
    // and we are setting the username state to the value gotten from the
    // localStorage.
    componentWillMount() {
        this.setState({ username: localStorage.username });
        // Establish a connection to Pusher.
        this.pusher = new Pusher('28a766a78a2d6adc3b4f', {
